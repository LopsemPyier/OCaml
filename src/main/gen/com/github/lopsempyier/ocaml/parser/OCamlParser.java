...
package com.github.lopsempyier.ocaml.parser;
...
import static com.github.lopsempyier.ocaml.psi.OCamlTypes.*;
...
public class OCamlParser implements PsiParser, LightPsiParser {
    ...
    /* ********************************************************** */
    // item_*
    static boolean ocamlFile(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "ocamlFile")) return false;
        while (true) {
            int c = current_position_(b);
            if (!item_(b, l + 1)) break;
            if (!empty_element_parsed_guard_(b, "ocamlFile", c)) break;
        }
        return true;
    }
    ...
    public static boolean property(PsiBuilder b, int l) {
        ...
        exit_section_(b, l, m, r, false, OCamlParser::recover_property);
        return r;
    }
